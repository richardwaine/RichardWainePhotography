...
<Image src={VestaSchneider} alt="Actor Headshots, Female Hair, Ponytail, Professional Headshots" class="article-header-image" />
...
<Image src={TiffanyRobinson} alt="Professional Headshots Lancaster, Acting Headshots Lancaster PA" class="hs-infographic" />
