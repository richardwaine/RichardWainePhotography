...
<Image src={ShreePatel} alt="Linkedin headshots,LinkedIn Profile Pictures, Headshots by Richard Waine" class="article-header-image" />
...
<Image src={PlanningHeadshots} alt="how far in advance to schedule headshots infographic" class="hs-infographic" />
...
<Image src={Chubb1} alt="professional headshot of african-american female at place of business" class="hs-infographic" />
