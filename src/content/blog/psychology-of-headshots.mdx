...
<Image src={QuarryViewConstruction} alt="Professional headshots,LinkedIn Profile Pictures, Headshots by Richard Waine" class="article-header-image" />
...
<Image src={FacialExpressions} alt="infographic showing how to achieve effective facial expressions in headshots" class="hs-infographic" />
