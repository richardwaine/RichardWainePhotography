...
<Image src={JonErlien} alt="Jon Erlien, Jon Erlien Photography" class="article-header-image" />
...
<Image src={JonErlien2} alt="professional table portrait" class="hs-infographic" />
...
<Image src={JonErlien3} alt="professional table portrait" class="hs-infographic" />
...
<Image src={JonErlien4} alt="professional table portrait" class="hs-infographic" />
...
<Image src={JonErlien5} alt="professional portrait" class="hs-infographic" />
...
<Image src={JonErlien6} alt="professional table portrait" class="hs-infographic" />
