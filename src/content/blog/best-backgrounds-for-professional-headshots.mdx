...
<Image src={BrianNguyen1} alt="Professional Headshots, best backgrounds for headshots, LinkedIn Profile Pictures, Headshots by Richard Waine" class="article-header-image" />
...
<Image src={Chubb1} alt="example of professional headshot portrait on a grey background, headshots for professionals" class="hs-infographic" />
...
<Image src={JackCottrell} alt="example of professional headshot portrait on a black background, headshots for actors" class="hs-infographic" />
...
<Image src={BrianNguyen2} alt="example of professional headshot portrait on a hand-painted canvas background" class="hs-infographic" />
