...
headerImage:
  ...
  alt: FedEx logo showing hidden arrow
...
imageAlt: FedEx logo showing hidden arrow
...
<Image src={FedEx} alt="FedEx logo showing hidden arrow" class="article-header-image" />
...
<Image src={EllenTaylor} alt="Professional Headshot of caucasian female executive on White Background" class="hs-infographic" />
...
<Image src={DavidBraught} alt="Professional headshots, actor headshots, headshots for men, facial expression coaching" class="hs-infographic" />
