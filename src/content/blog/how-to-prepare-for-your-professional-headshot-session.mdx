...
<Image src={AccelerateMortgage} alt="Professional headshots,LinkedIn Profile Pictures, Headshots by Richard Waine" class="article-header-image" />
...
<Image src={ImpactOfClothing} alt="infographic showing the impact of clothing fit on professional image" class="hs-infographic" />
