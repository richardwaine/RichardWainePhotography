...
<Image src={AccelerateMortgage} alt="Professional headshots, Website Profile Pictures, Headshots by Richard Waine" class="article-header-image" />
...
<Image src={PowerOfHeadshots} alt="infographic showing the power and advantages of professional headshots" class="hs-infographic" />
