...
<Image src={SallieMae1} alt="Linkedin headshots,LinkedIn Profile Pictures, Headshots by Richard Waine" class="article-header-image" />
...
<Image src={BuildingTrust} alt="infographic showing that trust is built through visual branding" class="hs-infographic" />
